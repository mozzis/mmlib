========================================================================
    STATIC LIBRARY : MemDC Project Overview
========================================================================

AppWizard has created this MemDC library project for you. 
This file contains a summary of what you will find in each of the files that
make up your MemDC application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MemDC.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MemDC.rc" and a "MemDC.h" that 
