...
// 
// *****************  Version 4  *****************
// User: Maynard      Date: 11/14/00   Time: 1:09p
// Updated in $/ZyluxZip/Grid
// Add IMPLEMENT/DECLARE_DYNAMIC macros for run-time type ID
// 
// *****************  Version 3  *****************
// User: Maynard      Date: 11/09/00   Time: 5:05p
// Updated in $/ZyluxZip/Grid
// In EndEdit, check window handle before sending close message in case
// some other action deleted the window first
 * 
 * *****************  Version 2  *****************
