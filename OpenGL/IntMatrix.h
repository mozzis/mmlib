...
public:
	...
	friend void AFX_EXT_API AFXAPI operator<<(CArchive& ar, CIntMatrix& matrix);
	friend void AFX_EXT_API AFXAPI operator>>(CArchive& ar, CIntMatrix& matrix);
...
void AFX_EXT_API reduceSize(CIntMatrix& inMatrix, const int& maxTotal);
void AFX_EXT_API reduceSize(CIntMatrix& inMatrix, const int& maxRows, const int& maxColumns);
