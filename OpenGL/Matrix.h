...
public:
	...
	friend void AFX_EXT_API AFXAPI operator<<(CArchive& ar, CMatrix& matrix);
	friend void AFX_EXT_API AFXAPI operator>>(CArchive& ar, CMatrix& matrix);
...
double AFX_EXT_API matMaxFinite(const CMatrix& inMatrix);
double AFX_EXT_API matMinFinite(const CMatrix& inMatrix);
...
double AFX_EXT_API mean(const CMatrix& inMatrix);
double AFX_EXT_API meanFinite(const CMatrix& inMatrix);
double AFX_EXT_API rms(const CMatrix& inMatrix);
double AFX_EXT_API rmsFinite(const CMatrix& inMatrix);
...
void AFX_EXT_API huge2value(CMatrix& inMatrix, double value);

void AFX_EXT_API reduceSize(CMatrix& inMatrix, const int& maxTotal);
void AFX_EXT_API reduceSize(CMatrix& inMatrix, const int& maxRows, const int& maxColumns);

BOOL AFX_EXT_API LinSolveGaussSimple(const CMatrix& A, const CMatrix& b, CMatrix& x);
